                                            ...
                                            <div style={{ height: 300 }}>
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <LineChart data={ts.data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                                        ...
                                                        <YAxis axisLine={false} tickLine={false} tick={{ fill: '#8b90b8', fontSize: 12 }} width={80} tickFormatter={(val: number) => new Intl.NumberFormat('en-US', { maximumFractionDigits: 2 }).format(val)} />
                                                        <Tooltip 
                                                            ...
                                                            formatter={(val: number) => new Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(val)}
                                                        />
